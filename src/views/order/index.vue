...
<!--                </Col>-->
        ...
        <Table :data="list" :columns="columns">
            <template slot-scope="{ row }" slot="user_id">{{ row.user.id }}</template>
            ...
            <template slot-scope="{ row }" slot="status">
                ...
                <template v-else-if="row.status === 4">退款</template>
            </template>
    ...
    export default {
        ...
        data () {
            return {
                ...
                columns: [
                    { key: 'recordId', title: '订单编号', width: 180 },
                    { key: 'payNo', title: '第三方支付流水号', width: 240 },
                    { slot: 'memberId', title: '用户ID', width: 150 },
                    { slot: 'phone', title: '手机号码', width: 150 },
                    { slot: 'goodsName', title: '商品名称', width: 150 },
                    { slot: 'quantity', title: '数量', width: 120 },
                    { slot: 'priceTotal', title: '总价格', width: 150 },
                    { slot: 'status', title: '订单状态', width: 100 },
                    { slot: 'payChannel', title: '下单渠道', width: 100 },
                    { slot: 'platform', title: '下单平台', width: 100 },
                    { key: 'timePay', title: '付款时间', width: 160 }
                ],
